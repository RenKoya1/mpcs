...
import { VectorDatabase, getGlobalVectorDatabase } from './vector-database.js';
import {
  SemanticSimilarityEngine,
  SemanticSimilarityEngineProxy,
  PREDEFINED_MODELS,
  type ModelPreset,
} from './semantic-similarity-engine.js';
...
export class ContentIndexer {
  ...
  private async performCompleteDataCleanupForModelSwitch(): Promise<void> {
    ...
    try {
      ...
      try {
        const { clearAllVectorData } = await import('./vector-database.js');
